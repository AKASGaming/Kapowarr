...
from backend.base.definitions import (ApiResponse, BlocklistReason,
                                      BlocklistReasonID, DownloadSource,
                                      FailReason, KapowarrException)
...
class InvalidSettingKey(KapowarrException):
    ...
    def __init__(self, key: str) -> None:
        self.key = key
        LOGGER.warning(
            f"No setting matched the given key: {key}"
        )
        return
...
class InvalidSettingValue(KapowarrException):
    ...
    def __init__(self, key: str, value: Any):
        ...
        self.value = value
        LOGGER.warning(
            f"The value for this setting is invalid: {key}={value}"
        )
        return
...
class LinkBroken(KapowarrException):
    ...
    def __init__(self, reason: BlocklistReason) -> None:
        ...
        LOGGER.warning(
            f"Download link is broken: {self.reason_text}"
        )
        return
...
class ClientNotWorking(KapowarrException):
    ...
    def __init__(self, description: str) -> None:
        self.desc = description
        LOGGER.warning(
            f"The download client isn't working: {self.desc}"
        )
        return
